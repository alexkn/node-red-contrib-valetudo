...
describe("valetudo-parse-binmap Node", function () {
    ...
    it("should parse binmap from Valetudo RE 0.9.0 with Firmware 2008 correctly", async function() {
        let flow = [
            { id: "n1", type: "valetudo-parse-binmap", wires:[["n2"]] },
            { id: "n2", type: "helper" }
        ];
        ...
        let expected = JSON.parse(await fs.readFile("./test/data/FW2008_RE0.9.0.json", { encoding: "utf-8" }));
